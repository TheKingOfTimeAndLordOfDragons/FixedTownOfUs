...
namespace TownOfUs
{
    ...
    public static class Keybinds
    {
        ...
        private static void Prefix(InputManager_Base __instance)
        {
            ...
            __instance.userData.RegisterBind("ToU cycle +", "Cycle forward mimic / transport menu");
            __instance.userData.RegisterBind("ToU cycle -", "Cycle backward mimic / transport menu");
            __instance.userData.RegisterBind("ToU confirm", "Confirm mimic / transport");
        }
