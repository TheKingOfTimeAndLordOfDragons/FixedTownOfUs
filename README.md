## *Note: This repository is a fork of [Town of Us](https://github.com/eDonnes124/Town-Of-Us-R) that fixes bugs, add new features*

![LOGO](./Images/TOU-logo.png)

An Among Us mod that adds a bunch of roles, modifiers and game settings

| **Crewmate Roles** | **Neutral Roles** | **Impostor Roles** |
|:---------------------------:|:---------------------------:|:---------------------------:|
| [Aurial](#aurial) | [Amnesiac](#amnesiac) | [Escapist](#escapist) |
| [Detective](#detective) | [Guardian Angel](#guardian-angel) | [Grenadier](#grenadier) |
| [Haunter](#haunter) | [Survivor](#survivor) | [Morphling](#morphling) |
| [Investigator](#investigator) | [Doomsayer](#doomsayer) | [Swooper](#swooper) |
| [Mystic](#mystic) | [Executioner](#executioner) | [Venerer](#venerer) |
| [Oracle](#oracle) | [Jester](#jester) | [Bomber](#bomber) |
| [Seer](#seer) | [Phantom](#phantom) | [Traitor](#traitor) |
| [Snitch](#snitch) | [Arsonist](#arsonist) | [Warlock](#warlock) |
| [Spy](#spy) | [Juggernaut](#juggernaut) | [Blackmailer](#blackmailer) |
| [Tracker](#tracker) | [Plaguebearer](#plaguebearer) | [Janitor](#janitor) |
| [Trapper](#trapper) | [The Glitch](#the-glitch) | [Miner](#miner) |
| [Sheriff](#sheriff) | [Vampire](#vampire) | [Undertaker](#undertaker) |
...
|:---------------------------:|:---------------------------:|:---------------------------:|
| [Aftermath](#aftermath) | [Button Barry](#button-barry) | [Disperser](#disperser) |
| [Bait](#bait) | [Flash](#flash) | [Double Shot](#double-shot) |
| [Diseased](#diseased) | [Giant](#giant) | [Underdog](#underdog) |
| [Frosty](#frosty) | [Radar](#radar) | |
| [Multitasker](#multitasker) | [Lovers](#lovers) | |
| [Torch](#torch) | [Sleuth](#sleuth) | |
...
<details>
  ...
  <ul> <li>Fix: Aurial see Swooper's true color</li> </ul>
  <ul> <li>Fix: Prosecutor will not be exiled if he kick crew lover</li> </ul>
  <ul> <li>Fix: Veteran can kill through First Kill Shield</li> </ul>
  <ul> <li>New: Phantom and Haunter no longer become the first dead crew/neut</li> </ul>
  <ul> <li>New: You can see Gamemode in Ping Tracker</li> </ul>
  <ul> <li>New: You will not see Classic/Cultist/All Any/Killing Only settings if you choose Classic/All Any/Killing Only/Cultist Gamemode</li> </ul>
  <ul> <li>Rework: Any shield will be visible if camo comms inactive, glitch mimicked in shielded player, morphling morphed in shielded player</li> </ul>
  <ul> <li>Rework: Sheriff And Prosecutor can't be Executioner's target</li> </ul>
  <ul> <li>Fix: Impostors can't see their teammates with "Impostor" role</li> </ul>
  <ul> <li>New: You can see GA/Exe targets and Lovers in End Game Summary</li> </ul>
  <ul> <li>Fix: Ghosts can see Roles and Modifiers when "Ghosts Can See Roles/Modifiers/Tasks/Votes" option is off</li> </ul>
  </details>
</details>
